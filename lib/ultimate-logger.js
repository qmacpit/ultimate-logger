...
module.exports = {
	...
	setFormat: function(format) {
        _format.f = format;
		// _format.properties = [];
		// var indexStart = -1, indexStop = -1, currentIndex = 0, length = _format.f.length;
  ...
  //                   break;
		...
		// 	indexStop = _format.f.indexOf("}}", currentIndex + 2);
		// 	currentIndex = indexStop;
		// 	_format.properties.push(_format.f.substring(indexStart + 2, indexStop))
		// }
	},    
